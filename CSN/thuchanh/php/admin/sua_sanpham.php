        ...
        if (isset($_FILES['hinhAnh']) && $_FILES['hinhAnh']['error'] == 0) {
            ...
            if ($uploadOk == 1) {
                if (move_uploaded_file($_FILES["hinhAnh"]["tmp_name"], $target_file)) {
                    // Xóa ảnh cũ
                    $sqlDeleteHinhAnh = "DELETE FROM hinhanh WHERE sanpham_id = '$ma'";
$resultGetImages = $conn->query($sqlHinhAnh);
...
<div class="row">
    ...
    <div class="col-10">
        <div class="container mt-3">
            ...
            <form action="sua_sanpham.php?ma=<?php echo $ma_val; ?>" method="post" enctype="multipart/form-data">
                <div class="mb-3 mt-3">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input value="<?php echo $gia_val; ?>" type="number" class="form-control" id="gia"
                ...
                <!-- Hiển thị ảnh sản phẩm trước đó -->
                <?php
                if (isset($hinhanh_val)) {
                    echo "<div class='mb-3 mt-3'>";
                    echo "<label>Ảnh sản phẩm trước đó</label>";
                    echo "<img src='" . $hinhanh_val . "' alt='Ảnh sản phẩm' style='max-width: 100px; max-height: 100px; margin-right: 10px;'>";
                    echo "</div>";
                }
                ?>
